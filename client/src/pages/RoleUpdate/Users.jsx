...
const Users = () => {
    ...
    return (
        <div className="overflow-x-auto overflow-y-auto mx-2">
            <div className='grid grid-cols-1 text-center p-5 m-2'>USER ROLE UPDTE</div>
          ...
          <tbody>
            ...
            {users.map((user, index) => (
              <tr key={user._id} >
                ...
                <td><button className="btn btn-primary btn-sm text-white" onClick={() => onItemClick(user)}>Update Role</button></td>
